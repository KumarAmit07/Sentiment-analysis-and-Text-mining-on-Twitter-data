...
twitter_data = read.table(file="F:/Social Media Data Analytics/result.csv", header=TRUE,sep=",",encoding="UTF-8", stringsAsFactors = FALSE)
...
text_corpus = tm_map(text_corpus, removeWords, c(stopwords("english"), "india"))
